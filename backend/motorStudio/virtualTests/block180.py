...
class block180(object):
    """Calculates the natural performance curve of the motor controlled by the so-called 180deg block-commutation (also known as the 6-step control)."""
    ...
    def __init__(self, machine=None, speeds=[1000], temperatures=[25], numberofPeriods=1, numberofTimeSteps=120):
        ...
        self.caption = "Performance Virtual Test (180 Degrees Six-Step Block Commutation)"
        self.description = ""
        ...
        if self.machine != None:
            ...
            self.__statorSegmentAngle = self.machine[
                "design"]["Stator"]["Segment Angle (deg)"]
            self.__rotorSegmentAngle = self.machine[
                "design"]["Rotor"]["Segment Angle (deg)"]
            ...
            self.__phaseConnection = self.machine["design"]["Winding"]["Phase Connection"]["name"]
        ...
        for temperature in self.temperatures:
            if createNewMaterials:
                ...
                for speed in self.speeds:
                    ...
                    oDesktop.AddMessage("", "", 1, "Running block180 test...")
